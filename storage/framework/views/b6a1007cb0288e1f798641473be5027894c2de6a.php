                    ...
                    <table class="table table-striped table-bordered nowrap" id="inscripciones">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="0" scope="col">Teléfono de contácto</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/upnegoci/mexiquilloenduro.uptradingexperts.com/resources/views/admin/show.blade.php ENDPATH**/ ?>