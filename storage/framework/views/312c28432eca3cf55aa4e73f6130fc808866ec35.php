              ...
              <div class="col-md-6 col-12">
                <div class="form-floating mb-3">
                  <select class="form-control" id="paqueteInput" name="paquete" required>
                    <option value="" selected>Selecciona..</option>
                    <option value="3500">Paquete completo ($3,500.00)</option>
                    <option value="2300">Ruta, jersey y buff ($2,300.00)</option>
...
</html><?php /**PATH C:\xampp\htdocs\mexiquillazolaravel\resources\views/layouts/index.blade.php ENDPATH**/ ?>