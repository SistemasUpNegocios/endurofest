        ...
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              ...
              <!--<li><a class="nav-link scrollto" href="{{ url('/cabañas') }}">Cabañas</a></li>-->
    ...
    <div class="intro-content position-absolute">
      <div class="container">
        <div class="justify-content-center">
          <img src="{{ asset('img/logo.png') }}" alt="" class="hero-img">
          ...
          <div class="col-lg-8 col-md-6 col-12 mt-2 mt-md-0 cont">
            <div class="box recommended shadow">
              <div class="imgs-container2">
                <img class="img-tierra" src="{{ asset('img/dirt.png') }}" alt="">
              </div>
              <div class="imgs-container">
                <img class="img-moto" src="{{ asset('img/enduro.png') }}" alt="">
              </div>
              <div class="info-container">
                ...
                <ul>
                  ...
                  <li><i class="ri-check-line"></i>3 comidas diarias {{--<a href="{{ url('/menu') }}" 
