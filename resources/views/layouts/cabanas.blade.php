...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
                    <a href="{{ url('/') }}" class="logo me-auto me-lg-0"><img src="{{ asset('img/logo.png') }}" alt=""
                            class="img-fluid"></a>

                    <nav id="navbar" class="navbar order-last order-lg-0">
                        <ul>
                            <li><a class="nav-link scrollto" href="{{ url('/') }}">Inicio</a></li>
                            <li><a class="nav-link scrollto" href="{{ url('/#reglamento') }}">Reglamento</a></li>
                            <li><a class="nav-link scrollto" href="{{ url('/#recomendaciones') }}">Recomendaciones</a></li>
                            <li><a class="nav-link scrollto active" href="{{ url('/cabañas') }}">Cabañas</a></li>
            ...
            <div class="row">
                    ...
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                ...
                                <img src="{{ asset('img/cabanas/miranchito.jpg') }}"
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/starita.webp') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/mirador.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/losalamos.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/santamaria.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/misierralinda.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/lalomita.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/lafogata.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/elranchero.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/encanto.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/rinconcito.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/montealto.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/montebello.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/hostalmexiquillo.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/lospinos.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/alturas.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/bellaluna.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/ojedas.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/elcomedero.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/parque.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/villasbosque.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/villascoronado.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/california.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/3encinos.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/praderaverde.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/chiricahua.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/quintoelemento.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/laescondida.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/laconsentida.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/puertademexiquillo.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/mazatleca.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/lajoyita.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/montana.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/elcapitan.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/elcampero.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/laroca.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/amarilla.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/lasierra.png') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
                ...
                <div class="col-lg-4">
                    <div class="section border bg-white rounded p-2">
                        <div class="row">
                            <div class="col-lg-12 img-section">
                                <img src="{{ asset('img/cabanas/miramonte.jpg') }}"
                                    class="p-0 m-0 res-ponsive img-prop">
                            </div>
                            <div class="col-lg-12 sectin-title">
    ...
    <footer id="contacto">
        <div class="container">
            <img src="{{ asset('img/logo.png') }}" alt="" class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form id="inscripcionForm" action="{{ URL::to('admin/addInscripcion') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-12">
